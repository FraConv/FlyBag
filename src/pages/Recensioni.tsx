        ...
        {Array.from({ length: 5 }, (_, i) => {
          ...
          return (
            <div key={star} className="flex items-center gap-2 mb-2">
              <span style={{color:"black"}} className="w-[3.5rem] text-sm text-black">{star}</span>
              ...
              <span style={{color:"black"}} className="w-6 text-sm text-black text-right">{count}</span>
            </div>
          );
        })}
      </div>
          ...
          <div className="bg-[#f3f3f3] mt-48 rounded-3xl p-4 flex flex-col items-center pb-8 mb-[1.9rem]">
            {filtraCommenti().map(recensione => (
              <div key={recensione.id} className="bg-[#f3f3f3] w-full p-4 mb-4 border-b border-b-[#9faec0] flex gap-4">
