...
export const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { icon: cardOutline, label: 'Payment Method', route: '/user/payment-method' },
      { icon: locationOutline, label: 'Modify Address', route: '/user/address' },
      { icon: mailOpenOutline, label: 'My orders', route: '/user/orders' }
    ]
  },
  {
    id: 'settings',
